...
class ScanSetting {
    ...
    static File sFileContainsInitClass;

    static final String PLUGIN_NAME = "xrouter"
    /**
     * The register code is generated into this class:com\example\xrouter_core\LogisticsCenter.java
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/example/xrouter_core/LogisticsCenter'
    /**
    ...
    /**
     * The package name of the class generated by the annotationProcessor:com/example/xrouter/routes/
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/example/xrouter/routes/'
    /**
     * The package name of the interfaces:com/example/xrouter_core/template/
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/example/xrouter_core/template/'
