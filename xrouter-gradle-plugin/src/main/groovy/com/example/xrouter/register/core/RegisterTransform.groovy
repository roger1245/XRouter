...
class RegisterTransform extends Transform {
    ...
    void transform(Context context, Collection<TransformInput> inputs
        ...
        if (ScanSetting.sFileContainsInitClass) {
            ScanSetting.registerList.each { ext ->
                Logger.i('Insert register code to file ' + ScanSetting.sFileContainsInitClass.absolutePath)
